...
sub card : Tests(9) {
    ...
    is($@->message, sprintf('%s is not an instance of "Stancer::Card".', $bad), 'Message check');
...
sub customer : Tests(9) {
    ...
    is($@->message, sprintf('%s is not an instance of "Stancer::Customer".', $bad), 'Message check');
...
sub device : Tests(9) {
    ...
    is($@->message, sprintf('%s is not an instance of "Stancer::Device".', $bad), 'Message check');
...
sub payment : Tests(9) {
    ...
    is($@->message, sprintf('%s is not an instance of "Stancer::Payment".', $bad), 'Message check');
...
sub refund : Tests(9) {
    ...
    is($@->message, sprintf('%s is not an instance of "Stancer::Refund".', $bad), 'Message check');
...
sub sepa : Tests(9) {
    ...
    is($@->message, sprintf('%s is not an instance of "Stancer::Sepa".', $bad), 'Message check');
...
sub sepa_check : Tests(9) {
    ...
    is($@->message, sprintf('%s is not an instance of "Stancer::Sepa::Check".', $bad), 'Message check');
